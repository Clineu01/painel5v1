...
wget https://github.com/Clineu01/painel5v1/main/painelwv5/sshplus.zip.001 > /dev/null 2>&1
wget https://github.com/Clineu01/painel5v1/main/painelwv5/sshplus.zip.002 > /dev/null 2>&1
wget https://github.com/Clineu01/painel5v1/main/painelwv5/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget https://github.com/Clineu01/painel5v1/main/painelwv5/sincpainel.zip > /dev/null 2>&1
